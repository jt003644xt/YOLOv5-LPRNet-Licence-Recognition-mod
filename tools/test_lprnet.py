...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', default=r'C:\Users\jt003\PycharmProjects\YOLOv5-LPRNet-Licence-Recognition-mod\runslprnet-pretrain.pth', help='pretrained base model')
